...
- **String Catalog metadata**: Preserve Xcode metadata such as autogenerated comments during read and write operations
...
```bash
mise use -g github:Ryu0118/xcstrings-crud
```
